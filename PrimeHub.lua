-- PrimeHub 6.0 public loader
local BASE = "https://raw.githubusercontent.com/softiksun5-hue/PrimeHub/main/release/PrimeHub-6.0.lua"
...
if not ok or type(body) ~= "string" or #body < 100 then
    error("[PrimeHub 6.0] Could not download the fresh protected release: " .. tostring(body))
end
