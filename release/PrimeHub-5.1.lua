...
if #payload~=20288 then error("[PrimeHub 5.1] Patch size mismatch: "..tostring(#payload)) end
local a1,a2=1,0
for i=1,#payload do a1=(a1+string.byte(payload,i))%65521; a2=(a2+a1)%65521 end
if (a2*65536+a1)~=3573141554 then error("[PrimeHub 5.1] Patch integrity check failed") end
